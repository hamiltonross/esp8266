...
const char* wifi_ssid = "4GEEHuaweiE5776-0834";
const char* wifi_passwd = "AE4Y711N";

const char* relay_domain = "hubotron-cfbz-43e4";
const char* yaler_url = "try.yaler.io";

ESP8266WebServer http_rest_server(HTTP_REST_PORT);
// YalerESP8266WiFiServer http_rest_server(yaler_url, HTTP_REST_PORT, relay_domain);
